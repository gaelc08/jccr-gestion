// popup.js — v2026.05.16-16
// Délègue le flux au background worker
let adherents = [];
...
// Lire le statut du background et l'afficher
function syncStatus() {
  chrome.storage.session.get(['flowStatus'], r => {
    if (r.flowStatus) showStatus(r.flowStatus.msg, r.flowStatus.type);
  });
}

// Rafraîchir le statut toutes les 800ms quand la popup est ouverte
...
btnFill.addEventListener('click', async () => {
  ...
  showStatus('Démarrage du flux...', 'info');
